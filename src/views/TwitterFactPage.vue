...
export default {
    ...
    methods: {
        ...mapActions(useSosmedStore, ['postTwitterFact']),

        // SUBMIT
        submitForm() {
            this.postTwitterFact(this.keyword)
        },
  ...
  <ol role="list" class="mx-auto flex w-full max-w-screen-xl space-x-4 px-4 sm:px-6 lg:px-8">
    ...
    <li class="flex">
      <div class="flex items-center">
        ...
        <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Twitter Fun Fact Generator</a>
      </div>
    </li>
  </ol>
</nav>
    ...
    <h1>Twitter Fun Fact Generator</h1>
            <div class="form-wrap">
