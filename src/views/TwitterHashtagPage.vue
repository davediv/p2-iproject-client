...
export default {
    ...
    methods: {
        ...mapActions(useSosmedStore, ['postTwitterHashtag']),

        // SUBMIT
        submitForm() {
            this.postTwitterHashtag(this.keyword)
        },
  ...
  <ol role="list" class="mx-auto flex w-full max-w-screen-xl space-x-4 px-4 sm:px-6 lg:px-8">
    ...
    <li class="flex">
      <div class="flex items-center">
        ...
        <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Twitter Hashtag Generator</a>
      </div>
    </li>
  </ol>
</nav>
    ...
    <h1>Twitter Hashtag Generator</h1>
            <div class="form-wrap">
                <form @submit.prevent="submitForm">
                    <input v-model="keyword" type="text" id="keyword" name="keyword" placeholder="Masukan topik hashtag">
